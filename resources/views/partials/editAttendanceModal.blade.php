<dialog id="editAttendanceModal" class="modal">
    <form method="dialog" id="editAttendanceForm" class="modal-box max-w-md p-6 rounded-xl shadow-lg bg-white">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <button type="button" class="text-gray-500 hover:text-gray-700 hover:bg-gray-200 rounded-full p-1 transition" onclick="editAttendanceModal.close()">
                ✕
            </button>
        </div>
        ...
        <div class="flex justify-end gap-2 mt-4">
            <button type="submit" class="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-md px-4 py-2 transition">
                <i class="bx bx-save"></i> Save Changes
            </button>
            <button type="button" class="flex items-center gap-2 border border-gray-300 rounded-md px-4 py-2 hover:bg-gray-100 transition" onclick="editAttendanceModal.close()">
