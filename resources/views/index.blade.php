  ...
  <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
    ...
    <div class="flex gap-3 items-center w-full md:w-auto">
      <div class="relative w-full md:w-64">
        <input type="text" placeholder="Search employees..." class="input input-bordered w-full pr-12 focus:ring-2 focus:ring-blue-400 focus:border-blue-500 transition">
        <i class="fas fa-search absolute right-3 top-1/2 -translate-y-1/2 text-gray-400"></i>
      </div>
      <button class="btn btn-primary gap-2 shadow-lg hover:scale-105 transition-transform" onclick="document.getElementById('adminDialog').showModal()">
    ...
    <table class="table table-zebra table-hover w-full text-center border border-gray-200 rounded-lg">
      ...
      <tbody>
        <tr class="hover:bg-blue-50 transition-colors">
          ...
          <td><img src="https://via.placeholder.com/80x50" alt="Profile" class="mx-auto rounded-full border border-gray-300"></td>
