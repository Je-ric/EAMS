...
<dialog id="updateModal" class="modal">
    <div class="modal-box max-w-4xl p-6 rounded-xl shadow-lg bg-white">
        ...
        <!-- Form -->
        <form method="POST" action="{{ route('employees.update') }}" id="updateForm" enctype="multipart/form-data" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <!-- Submit -->
            <div>
                <button type="submit" class="w-full bg-blue-600 text-white rounded-md px-4 py-2 hover:bg-blue-700 transition flex items-center justify-center gap-2">
